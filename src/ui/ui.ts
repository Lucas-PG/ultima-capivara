...
export class GameUI {
  ...
  setPaused(paused: boolean) {
    ...
    panel.innerHTML = `<div class="mc"><div class="eyebrow stk">Partida em andamento · ${alive} ${alive === 1 ? 'vivo' : 'vivos'}${online && this.room ? ` · Sala ${esc(this.room.code)}` : ''}</div><h1>${online ? 'Menu' : 'Pausado'}</h1>`
