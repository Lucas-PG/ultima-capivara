  ...
  try {
    ...
    const baselineBytes = await host.evaluate(async () => {
      ...
      const actor: ActorState = { id: s.state.myId, name: 'Host', color: '#1fb5a8', bot: false, connected: true,
        ...
        sprint: false, ads: false, swimming: false, wetUntil: 0, emote: 'wave', emoteUntil: 4, weaponLevel: 2, soaking: false, bounceSeq: 0, bounceProtected: false, stage: 'ground', kills: 0, deaths: 0, damage: 0,
